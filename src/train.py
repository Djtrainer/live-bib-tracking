...
def train_model():
    ...
    model = YOLO('yolov8n.pt') # Or 'yolov8n.pt' for the fastest version
    ...
    results = model.train(
        ...
        epochs=50,                      # Number of training epochs (e.g., 50-100)
        imgsz=640,                      # Image size for training
        name='yolov8n_bib_detector'     # Name for the output folder
    )
