...
if [[ $# -eq 0 ]] || [[ "$1" == "--help" ]] || [[ "$1" == "-h" ]]; then
    ...
    echo "  --model PATH     Path to trained YOLO model (default: runs/detect/yolo11_new_data/weights/last.pt)"
...
MODEL_FILE=${MODEL_FILE:-"runs/detect/yolo11_new_data/weights/last.pt"}
